...
public abstract class W3Object<T extends W3OBase<?>> implements W3OContext<T> {
	...
	private int id;
	private final Map<Long, Property<?>> properties = new Hashtable<>();

	private T context;

	/**
	 * Returns the current context of this object, usually the file its
	 * contained in.
	 *
	 ...
	 *
	 * @param context
	 *            the new context of this object.
	 */
	@Override
	...
	/**
	 * Returns the ID of the parent object. If this object is a standard WC3
	 * object, this objects ID will be returned.
	 *
	 ...
	 *
	 * @return <code>true</code> if this is a standard object,
	...
	/**
	 * Creates a new object with the specified parent (identified by its ID) and
	 * the specified ID.
	 *
	 * @param parentId
