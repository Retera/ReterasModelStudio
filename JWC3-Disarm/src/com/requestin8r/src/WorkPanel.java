...
public class WorkPanel extends JPanel implements ActionListener {
	...
	public WorkPanel(final Project project, final MainFrame frame) {
		...
		viewer = new PerspDisplayPanel("", project.model);
...
//			frame2.setVisible(true);
			...
			final int x = JOptionPane.showConfirmDialog(frame,"Are you sure you wish to leave, losing any unsaved progress on "+title.getText() + "?", "Confirmation", JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE);
