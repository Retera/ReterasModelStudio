				...
				case MdlUtils.TOKEN_PARTICLE -> {
					...
					while (iterator.hasNext()) {
						...
						switch (subToken) {
							...
							default -> MdlxParseLog.addStringToShow("Line " + stream.getLineNumber() + ": Unknown token in ParticleEmitter " + name + "'s Particle: " + subToken);
						}
					}
				}
				default -> MdlxParseLog.addStringToShow("Line " + stream.getLineNumber() + ": Unknown token in ParticleEmitter " + name + ": " + token);
			}
		}
	}
