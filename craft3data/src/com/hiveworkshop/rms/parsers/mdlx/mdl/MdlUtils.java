...
public class MdlUtils {
	...
	public static final String TOKEN_ANIM_VISIBILITY_GUIDE = "AnimVisibilityGuide";
	...
	// Warcraft III 3.0 (Forsaken Kingdom) keywords, from the game's MDL keyword table
	public static final String TOKEN_SHADOW_INTENSITY          = "ShadowIntensity";
	public static final String TOKEN_STATIC_SHADOW_INTENSITY   = TOKEN_STATIC + " " + TOKEN_SHADOW_INTENSITY;
	public static final String TOKEN_SHADOW_CASTING            = "ShadowCasting";
	public static final String TOKEN_SHADOW_CASTING_START      = "ShadowCastingStart";
	public static final String TOKEN_STATIC_SHADOW_CASTING_START = TOKEN_STATIC + " " + TOKEN_SHADOW_CASTING_START;
	public static final String TOKEN_SHADOW_CASTING_END        = "ShadowCastingEnd";
	public static final String TOKEN_STATIC_SHADOW_CASTING_END = TOKEN_STATIC + " " + TOKEN_SHADOW_CASTING_END;
	public static final String TOKEN_QUADRATIC_FALLOFF         = "QuadraticFalloff";
	public static final String TOKEN_STATIC_QUADRATIC_FALLOFF  = TOKEN_STATIC + " " + TOKEN_QUADRATIC_FALLOFF;
	public static final String TOKEN_LINEAR_FALLOFF            = "LinearFalloff";
	public static final String TOKEN_STATIC_LINEAR_FALLOFF     = TOKEN_STATIC + " " + TOKEN_LINEAR_FALLOFF;
	public static final String TOKEN_DAMPING                   = "Damping";
	public static final String TOKEN_STATIC_DAMPING            = TOKEN_STATIC + " " + TOKEN_DAMPING;
	public static final String TOKEN_DOF_DISTANCE              = "DOFDistance";
	public static final String TOKEN_FOCAL_LENGTH              = "FocalLength";
	public static final String TOKEN_FSTOP                     = "FStop";
	public static final String TOKEN_BACK_FACES_FOR_SHADOWS    = "BackFacesForShadows";
	public static final String TOKEN_AMBIENT_OCCLUSION         = "AmbientOcclusion";
	public static final String TOKEN_GLIDER                    = "Glider";
	public static final String TOKEN_TEXTURE_SLOT_DESIGNATOR   = "<=";
