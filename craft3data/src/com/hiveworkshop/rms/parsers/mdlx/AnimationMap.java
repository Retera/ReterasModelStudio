...
/*  LIGHT  */
	...
	/** Light shadow casting start (3.0) */
	KLSS(MdlUtils.TOKEN_SHADOW_CASTING_START, MdlxTimelineType.FLOAT_TIMELINE),
	/** Light shadow casting end (3.0) */
	KLSE(MdlUtils.TOKEN_SHADOW_CASTING_END, MdlxTimelineType.FLOAT_TIMELINE),
	/** Light quadratic falloff (3.0) */
	KLQF(MdlUtils.TOKEN_QUADRATIC_FALLOFF, MdlxTimelineType.FLOAT_TIMELINE),
	/** Light linear falloff (3.0) */
	KLLF(MdlUtils.TOKEN_LINEAR_FALLOFF, MdlxTimelineType.FLOAT_TIMELINE),
	/** Light damping (3.0) */
	KLDA(MdlUtils.TOKEN_DAMPING, MdlxTimelineType.FLOAT_TIMELINE),
...
//	KCRL(MdlUtils.TOKEN_ROTATION, MdlxTimelineType.UINT32_TIMELINE),
	...
	/** Camera depth-of-field focus distance (3.0; the tag bytes are literally "IDUF") */
	IDUF(MdlUtils.TOKEN_DOF_DISTANCE, MdlxTimelineType.FLOAT_TIMELINE),
	/** Camera depth-of-field focal length in mm (3.0, "ELAF") */
	ELAF(MdlUtils.TOKEN_FOCAL_LENGTH, MdlxTimelineType.FLOAT_TIMELINE),
	/** Camera depth-of-field f-stop (3.0, "PTSF") */
	PTSF(MdlUtils.TOKEN_FSTOP, MdlxTimelineType.FLOAT_TIMELINE),
