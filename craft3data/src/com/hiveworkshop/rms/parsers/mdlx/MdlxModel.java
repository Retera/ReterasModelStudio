...
public class MdlxModel {
	...
	/**
	 * @since 1300 (Forsaken Kingdom). The DILG ("Glider") chunk: geoset ids that act as a ray-picking
	 *        whitelist. When non-empty only the listed geosets can be hit by the game's world-picking ray.
	 */
	public List<Integer> gliderGeosetIds = new ArrayList<>();
