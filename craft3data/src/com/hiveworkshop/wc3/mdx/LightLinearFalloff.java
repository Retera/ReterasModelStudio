...
/** MDX light track "KLLF": animated LinearFalloff (Warcraft III 3.0, MDX 1600+). One float per key. */
public class LightLinearFalloff {
	public int interpolationType;
	public int globalSequenceId;
	public ScalingTrack[] scalingTrack = new ScalingTrack[0];

	public static final String key = "KLLF";

	public void load(final BlizzardDataInputStream in) throws IOException {
		MdxUtils.checkId(in, "KLLF");
