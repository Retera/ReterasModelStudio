...
/**
 * MDX 1800 (Forsaken Kingdom) camera depth-of-field track with the tag bytes "PTSF" (reversed multi-char
 * constant like "PTSF"/"DILG"): aperture f-stop (values such as 2.8, 5.6, 8, 15 in stock data); "FStop" / "FStopKeys" MDL keywords. One float per key.
 */
public class CameraFStop {
	public int interpolationType;
	public int globalSequenceId;
	public TranslationTrack[] translationTrack = new TranslationTrack[0];

	public static final String key = "PTSF";

	public void load(BlizzardDataInputStream in) throws IOException {
		MdxUtils.checkId(in, "PTSF");
