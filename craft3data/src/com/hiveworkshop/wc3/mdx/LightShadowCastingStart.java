...
/** MDX light track "KLSS": animated ShadowCastingStart (Warcraft III 3.0, MDX 1300+). One float per key. */
public class LightShadowCastingStart {
	public int interpolationType;
	public int globalSequenceId;
	public ScalingTrack[] scalingTrack = new ScalingTrack[0];

	public static final String key = "KLSS";

	public void load(final BlizzardDataInputStream in) throws IOException {
		MdxUtils.checkId(in, "KLSS");
