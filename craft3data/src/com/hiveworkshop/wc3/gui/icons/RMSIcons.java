...
public class RMSIcons {
    ...
    public static ImageIcon loadImageIcon(final String path) {
        try {
            return new ImageIcon(ImageIO.read(MpqCodebase.get().getResourceAsStream("UI\\Widgets\\ReteraStudio\\" + path)));
    ...
    public static Image loadImage(final String path) {
        try {
            return ImageIO.read(MpqCodebase.get().getResourceAsStream("UI\\Widgets\\ReteraStudio\\" + path));
        } catch (final IOException e) {
            throw new RuntimeException(e);
        }
    }
    ...
    public static ImageIcon loadDataSourceImageIcon(String path) {
