...
public class BlockTable {
	...
	public BlockTable(final Entry[] entries) {
		tableArray = entries;
	}

	public Entry lookupEntry(final int entry) {
		return tableArray[entry];
	}

	public static String flagsToString(final int source){
	...
	public static class Entry{
		...
		public Entry(final BlockTableEntry source){
