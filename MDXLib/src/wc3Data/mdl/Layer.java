...
public class Layer implements Named, VisibilitySource
{
    ...
    ArrayList<AnimFlag> anims = new ArrayList<AnimFlag>();//Used instead of static alpha for animated alpha
    ...
    public void updateRefs(MDL mdlr) {
    	if( textureId >= 0 )
    		texture = mdlr.getTexture(textureId);
    	if( TVertexAnimId >= 0 )
    		textureAnim = mdlr.m_texanims.get(TVertexAnimId);
    	AnimFlag txFlag = getFlag("TextureID");
    	if( txFlag != null )
...
//                     JOptionPane.showMessageDialog(MDLReader.getDefaultContainer(),"Error parsing Layer: Unrecognized statement '"+line[i]+"'.");
                }
            }
            return lay;
        }
        ...
        {
            JOptionPane.showMessageDialog(MDLReader.getDefaultContainer(),"Unable to parse Layer: Missing or unrecognized open statement.");
        }
        return null;
    }
...
//                     JOptionPane.showMessageDialog(MDLReader.getDefaultContainer(),"Error parsing Layer: Unrecognized statement '"+line[i]+"'.");
	...
	public void setAnims(ArrayList<AnimFlag> anims) {
		this.anims = anims;
	}
	public ArrayList<Bitmap> getTextures() {
		return textures;
	}
	public void setTextures(ArrayList<Bitmap> textures) {
