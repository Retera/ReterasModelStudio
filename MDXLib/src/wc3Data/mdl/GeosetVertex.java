...
public class GeosetVertex extends Vertex
{
    ...
    public void updateMatrixRef(ArrayList<Matrix> list)
    {
        ...
        {
            JOptionPane.showMessageDialog(MDLReader.getDefaultContainer(),"Error in Matrices: VertexGroup does not reference a real matrix id!");
        }
    }
    ...
    public static GeosetVertex parseText(String input)
    {
        ...
        {
            JOptionPane.showMessageDialog(MDLReader.getDefaultContainer(),"Error {"+input+"}: Vertex coordinates could not be interpreted.");
        }
        try
        {
