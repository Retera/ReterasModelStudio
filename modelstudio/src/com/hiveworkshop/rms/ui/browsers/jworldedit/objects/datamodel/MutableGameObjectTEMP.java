...
//
//public final class MutableGameObjectTEMP {
...
//
//	public MutableGameObjectTEMP(MutableObjectData mutableObjectData, GameObject parentWC3Object,
...
//				&& !isCustom()) {
//			MutableGameObjectTEMP codeObject = mutableObjectData.get(War3ID.fromString(readSLKTag("code").substring(0, 4)));
//			if (codeObject != null) {
