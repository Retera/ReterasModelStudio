...
//			undoManager.pushAction(new EditabilityToggleHandler(components).showComponent(modelView, this::reloadFromModelView));
//		} else {
//			undoManager.pushAction(new EditabilityToggleHandler(components).hideComponent(modelView, this::reloadFromModelView));
//		}
//	}
//
