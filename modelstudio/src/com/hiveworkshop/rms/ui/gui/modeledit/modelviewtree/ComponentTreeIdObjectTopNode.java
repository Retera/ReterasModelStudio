...
public class ComponentTreeIdObjectTopNode extends NodeThing<String> {
	...
	public boolean equals(Object obj) {
		if (obj instanceof ComponentTreeIdObjectTopNode) {
			if (this == obj) {
				return true;
			}
//			System.out.println("ComponentTreeIdObjectTopNode equals " + this.getClass().getSimpleName() + " " + this.getClass().isInstance(obj));
			return this.getClass().isInstance(obj)
					&& this.modelHandler == ((ComponentTreeIdObjectTopNode) obj).modelHandler
					&& this.item.equals(((ComponentTreeIdObjectTopNode) obj).item);
		}
		return false;
	}
