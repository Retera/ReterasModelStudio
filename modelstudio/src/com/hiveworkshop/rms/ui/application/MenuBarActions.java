...
//                mainPanel.windowMenu.remove(modelPanel.getMenuItem());
    ...
    static void newModel(MainPanel mainPanel) {
	    ...
	    JRadioButton createEmptyButton = new JRadioButton("Create Empty", true);
        newModelPanel.add(createEmptyButton, "cell 0 1");
	    JRadioButton createPlaneButton = new JRadioButton("Create Plane");
        newModelPanel.add(createPlaneButton, "cell 0 2");
	    JRadioButton createBoxButton = new JRadioButton("Create Box");
	    ...
	    int userDialogResult = JOptionPane.showConfirmDialog(mainPanel, newModelPanel, "New Model",
			    JOptionPane.OK_CANCEL_OPTION, JOptionPane.PLAIN_MESSAGE);
...
//					testPanel.add(animationController);
    ...
    public static void addNewMaterial(MainPanel mainPanel) {
        ...
        if (current != null) {
	        ...
	        Bitmap white = new Bitmap("Textures\\White.dds");
