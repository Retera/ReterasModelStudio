...
public class AnimationControllerCanv extends JPanel {
	...
	public AnimationControllerCanv(PreviewPanelCanv previewPanel) {
	...
	public AnimationControllerCanv setModel(ModelHandler modelHandler, boolean allowUnanimated, Animation defaultAnimation) {
	...
	private JSpinner getLodSpinner(PreviewPanelCanv listener) {
	...
	public AnimationControllerCanv reload() {
