...
public class TPoseModelEditor extends AbstractModelEditor<IdObject> {
	...
	public TPoseModelEditor(final ModelView model,
	...
	public static void hitTest(final List<IdObject> selectedItems, final Rectangle2D area, final Vec3 geosetVertex, final CoordinateSystem coordinateSystem, final double vertexSize, final IdObject node) {
	...
	public UndoAction invertSelection() {
		...
		// @Override
		// public void ribbonEmitter(final RibbonEmitter particleEmitter) { toggleSelection(invertedSelection, particleEmitter.getPivotPoint()); }
		// @Override
		// public void particleEmitter2(final ParticleEmitter2 particleEmitter) { toggleSelection(invertedSelection, particleEmitter.getPivotPoint()); }
		// @Override
		// public void particleEmitter(final ParticleEmitter particleEmitter) { toggleSelection(invertedSelection, particleEmitter.getPivotPoint()); }
		// @Override
		// public void light(final Light light) { toggleSelection(invertedSelection, light.getPivotPoint()); }
		// @Override
		// public void helper(final Helper object) { toggleSelection(invertedSelection, object.getPivotPoint()); }
		// @Override
		// public void eventObject(final EventObject eventObject) { toggleSelection(invertedSelection, eventObject.getPivotPoint()); }
		// @Override
		// public void collisionShape(final CollisionShape collisionShape) {
		// toggleSelection(invertedSelection, collisionShape.getPivotPoint());
		// for (final Vertex vertex : collisionShape.getVertices()) { toggleSelection(invertedSelection, vertex); } }
		// @Override
		// public void camera(final Camera camera) {
		// toggleSelection(invertedSelection, camera.getPosition()); toggleSelection(invertedSelection, camera.getTargetPosition()); }
		// @Override
		// public void bone(final Bone object) { toggleSelection(invertedSelection, object.getPivotPoint()); }
		// @Override
		// public void attachment(final Attachment attachment) { toggleSelection(invertedSelection, attachment.getPivotPoint()); } };
		// for (final IdObject node : model.getEditableIdObjects()) { node.apply(visitor); }
		// for (final Camera object : model.getEditableCameras()) { visitor.camera(object); }
	...
	public UndoAction selectAll() {
		...
		// final IdObjectVisitor visitor = new IdObjectVisitor() {
		// @Override
		// public void ribbonEmitter(final RibbonEmitter particleEmitter) { allSelection.add(particleEmitter.getPivotPoint());}
		// @Override
		// public void particleEmitter2(final ParticleEmitter2 particleEmitter) { allSelection.add(particleEmitter.getPivotPoint());}
		// @Override
		// public void particleEmitter(final ParticleEmitter particleEmitter) { allSelection.add(particleEmitter.getPivotPoint());}
		// @Override
		// public void light(final Light light) { allSelection.add(light.getPivotPoint());}
		// @Override
		// public void helper(final Helper object) { allSelection.add(object.getPivotPoint());}
		// @Override
		// public void eventObject(final EventObject eventObject) { allSelection.add(eventObject.getPivotPoint());}
		// @Override
		// public void collisionShape(final CollisionShape collisionShape) {
		// allSelection.add(collisionShape.getPivotPoint());
		// for (final Vertex vertex : collisionShape.getVertices()) { allSelection.add(vertex);}}
		// @Override
		// public void camera(final Camera camera) {
		// allSelection.add(camera.getPosition()); allSelection.add(camera.getTargetPosition());}
		// @Override
		// public void bone(final Bone object) { allSelection.add(object.getPivotPoint());}
		// @Override
		// public void attachment(final Attachment attachment) { allSelection.add(attachment.getPivotPoint());}};
		// for (final IdObject node : model.getEditableIdObjects()) { node.apply(visitor);}
		// for (final Camera object : model.getEditableCameras()) { visitor.camera(object);}
	...
	public UndoAction deleteSelectedComponents() {
		...
		final DeleteNodesAction deleteNodesAction = new DeleteNodesAction(selectionManager.getSelectedVertices(), deletedIdObjects, deletedCameras, structureChangeListener, model, vertexSelectionHelper);
