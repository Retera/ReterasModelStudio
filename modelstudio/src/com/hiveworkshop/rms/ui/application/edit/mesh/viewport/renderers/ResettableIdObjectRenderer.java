...
public final class ResettableIdObjectRenderer {
	...
	private final Color lightsColor = Color.YELLOW.brighter();

	private final Vec2 minCoord = new Vec2();
	private final Vec2 maxCoord = new Vec2();
	private final Vec3 vertexHeap1 = new Vec3();
	private final Vec3 vertexHeap2 = new Vec3();
	private final Vec2 coordTemp = new Vec2();

	private final Vec2 vertSize = new Vec2();
	private final Vec2 ovalStart = new Vec2();
	private final Vec2 outerMin = new Vec2();
	private final Vec2 outerMax = new Vec2();
	...
	public void drawNodeImage(Graphics2D graphics, IdObject attachment, Image nodeImage) {
	...
	public void drawCollisionShape(Graphics2D graphics, int vertexSize, CollisionShape collisionShape) {
