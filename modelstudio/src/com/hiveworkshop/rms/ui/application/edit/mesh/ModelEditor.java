...
public interface ModelEditor extends ComponentVisibilityListener {
	...
	UndoAction setPosition(Vector3 center, double x, double y, double z);

	UndoAction rotate(Vector3 center, double rotateX, double rotateY, double rotateZ);

	UndoAction addVertex(double x, double y, double z, Vector3 preferredNormalFacingVector);

	UndoAction addBone(double x, double y, double z);

	GenericMoveAction addPlane(double x, double y, double x2, double y2, byte dim1, byte dim2, Vector3 facingVector,
							   int numberOfWidthSegments, int numberOfHeightSegments);

	GenericMoveAction addBox(double x, double y, double x2, double y2, byte dim1, byte dim2, Vector3 facingVector,
	...
	void rawRotate3d(Vector3 center, Vector3 axis, double radians);
	...
	UndoAction createFaceFromSelection(Vector3 preferredFacingVector);
}
