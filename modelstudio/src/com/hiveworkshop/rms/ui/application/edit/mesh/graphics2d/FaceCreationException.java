package com.hiveworkshop.rms.ui.application.edit.mesh.graphics2d;

public class FaceCreationException extends RuntimeException {

	public FaceCreationException() {
		super();
	}
