...
public final class Graphics2DToTVertexModelElementRendererAdapter implements TVertexModelElementRenderer {
	...
	public void renderFace(final Color borderColor, final Color color, final Vec2 a, final Vec2 b, final Vec2 c) {
		Point pointA = CoordinateSystem.convertToViewPoint(coordinateSystem, a);
		Point pointB = CoordinateSystem.convertToViewPoint(coordinateSystem, b);
		Point pointC = CoordinateSystem.convertToViewPoint(coordinateSystem, c);
	...
	public void renderVertex(final Color color, final Vec2 vertex) {
		Point pointA = CoordinateSystem.convertToViewPoint(coordinateSystem, vertex);
		graphics.setColor(color);
