...
public class TimelineTextEditor<T> {
	...
	public JPanel getEditorPanel(){
		...
		okButton.addActionListener(e -> readEditorPane(editorPane));
	...
	private void apply() {
		...
		SetFlagEntryMapAction<T> action = new SetFlagEntryMapAction<>(animFlag, sequence, newEntryMap, ModelStructureChangeListener.changeListener);
		if(modelHandler != null){
...
//		JPanel mainPanel = textEditor.getEditorPanel();
//
//		mainPanel.setPreferredSize(ScreenInfo.getSmallWindow());
//		FramePopup.show(mainPanel, null, "UGG");
	}

	private static void readEditorPane(JEditorPane editorPane){
