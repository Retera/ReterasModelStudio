...
//                case -32 -> z = (float) -value;
	...
	// ToDo fix this!
	public Vec3 unProject(Vec2 v, Mat4 inverseMatrix) {
		Vec4 heap = new Vec4();
...
//		float z = 0;
		...
		heap.set(v.x, v.y, 0, 1);
		heap.transformInverted(inverseMatrix);
//		transformInverted11(inverseMatrix, 1);

		return set(heap.x, heap.y, heap.z).scale(1.0f/heap.w);
	}


	public Vec4 transformInverted11(Mat4 mat4, float w) {
		float b00 = mat4.m00 * mat4.m11 - mat4.m01 * mat4.m10;
		float b01 = mat4.m00 * mat4.m12 - mat4.m02 * mat4.m10;
		float b02 = mat4.m00 * mat4.m13 - mat4.m03 * mat4.m10;
		float b03 = mat4.m01 * mat4.m12 - mat4.m02 * mat4.m11;
	...
	public Vec3 setAsUnProjection(Vec2 vec2, Mat4 mat4){
		Vec3 vec3 = new Vec3(vec2.x, vec2.y, 0);
		...
		float newZ = (mat4.m01 * vec3.x) + (mat4.m11 * vec3.y) + (mat4.m21 * vec3.z) + mat4.m31;
		return set(newX, newY, newZ).scale(l_w);
	}
}
