...
public class ParticleEmitterShader {
	...
	public void renderParticles(final int blendSrc, final int blendDst, final int rows, final int cols, final Particle2TextureInstance texture, final RenderSharedGeometryEmitter.RenderData[] bufferData, final boolean isRibbonEmitter, final int numItemsToRender) {
		texture.bind();
