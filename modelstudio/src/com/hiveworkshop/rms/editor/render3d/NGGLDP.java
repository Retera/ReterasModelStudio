...
public class NGGLDP {
	...
	public static final class SimpleDiffuseShaderPipeline implements Pipeline {
		...
		private static final String vertexShader = "#version 330 core\r\n" + //
				...
				"			}\r\n" + //
				"			v_color.rgb *= lightFactorContribution + vec3(0.3f, 0.3f, 0.3f);\r\n" + //
				"		}\r\n" + //
				"}\r\n\0";
		...
		private Mat4 currentMatrix = new Mat4().setIdentity();
		...
		public void glVertex3f(float x, float y, float z) {
			...
			tempVec4.set(x, y, z, 1).transform(currentMatrix);
		...
		public void glNormal3f(float x, float y, float z) {
			...
			ensureCapacity(baseOffset + STRIDE);
			tempVec4.set(x, y, z, 1).transform(currentMatrix).normalize();
		...
		private Quat tempQuat = new Quat();
		private Mat4 tempMat4 = new Mat4();

		@Override
		public void glRotatef(float angle, float axisX, float axisY, float axisZ) {
			tempVec3.set(axisX, axisY, axisZ).normalize();
			currentMatrix.mul(tempMat4.fromQuat(tempQuat
					.setFromAxisAngle(tempVec3.x, tempVec3.y, tempVec3.z, (float) Math.toRadians(angle)).normalize()));
		}

		private Vec3 tempVec3 = new Vec3();
		private Vec4 tempVec4 = new Vec4();

		@Override
		public void glScalef(float x, float y, float z) {
			currentMatrix.mul(tempMat4.setIdentity().scale(tempVec3.set(x, y, z)));
		}

		@Override
		public void glTranslatef(float x, float y, float z) {
			currentMatrix.mul(tempMat4.setIdentity().translate(tempVec3.set(x, y, z)));
		}
...
//				+ "}\r\n"
				...
				"			FragColor = vec4(emissiveTexel.xyz + specular + diffuse, color.a);\r\n" + //
				"		} else {\r\n" + //
				"			FragColor = color;\r\n" + //
				"		}\r\n" + //
				"}\r\n\0";
