...
public class DeleteFaceEffectAction implements UndoAction {
	private final ModelStructureChangeListener changeListener;
	private final EditableModel model;
	private final Collection<FaceEffect> faceEffects;

	public DeleteFaceEffectAction(FaceEffect faceEffect, EditableModel model, ModelStructureChangeListener changeListener){
		this(Collections.singleton(faceEffect), model, changeListener);
	}
	public DeleteFaceEffectAction(Collection<FaceEffect> faceEffects, EditableModel model, ModelStructureChangeListener changeListener){
