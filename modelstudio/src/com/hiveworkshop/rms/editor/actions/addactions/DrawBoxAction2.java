...
public class DrawBoxAction2 implements GenericMoveAction {
...
//		dummy2.setCoord(getUnusedXYZ(dim1, dim2), 1);
		zHeight = 1;

		box = ModelUtils.createBox2(numberOfLengthSegments, numberOfWidthSegments, numberOfHeightSegments, planeGeoset);
	}
...
//
//		byte unusedXYZ = getUnusedXYZ(dim1, dim2);
