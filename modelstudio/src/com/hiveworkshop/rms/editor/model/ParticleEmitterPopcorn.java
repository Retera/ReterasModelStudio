...
public class ParticleEmitterPopcorn extends IdObject {
	...
	public ParticleEmitterPopcorn(final ParticleEmitterPopcorn emitter) {
		...
		alpha = emitter.alpha;
		color = new Vertex3(emitter.color);
		speed = emitter.speed;
	...
	public ParticleEmitterPopcorn(final MdlxParticleEmitterPopcorn emitter) {
		...
		emissionRate = emitter.emissionRate;
		speed = emitter.speed;
		color = new Vertex3(ModelUtils.flipRGBtoBGR(emitter.color));
		alpha = emitter.alpha;
		replaceableId = emitter.replaceableId;
		path = emitter.path;
	...
	public Vertex3 getColor() {
		return color;
	}

	public void setColor(final Vertex3 color) {
		this.color = color;
	}
