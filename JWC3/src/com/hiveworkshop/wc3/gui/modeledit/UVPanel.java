...
//             ));
    ...
    {
    	vp.init();
        buttons.get(0).setColors(dispMDL.getProgramPreferences().getActiveColor1(),dispMDL.getProgramPreferences().getActiveColor2());
        buttons.get(3).setColors(dispMDL.getProgramPreferences().getActiveRColor1(),dispMDL.getProgramPreferences().getActiveRColor2());
            ...
            new AbstractAction("shiftSelect")
            {
				...
				public void actionPerformed(ActionEvent e)
                {
                    if( selectionType == 0 )
                    {
                        ...
                        addButton.setColors(dispMDL.getProgramPreferences().getActiveColor1(),dispMDL.getProgramPreferences().getActiveColor2());
                        selectionType = 1;
                        cheatShift = true;
                    }
                }
                ...
                new AbstractAction("altSelect")
                {
					...
					public void actionPerformed(ActionEvent e)
                    {
                        if( selectionType == 0 )
                        {
                            ...
                            deselectButton.setColors(dispMDL.getProgramPreferences().getActiveColor1(),dispMDL.getProgramPreferences().getActiveColor2());
                            selectionType = 2;
                            cheatAlt = true;
                        }
                    }
            ...
            new AbstractAction("unShiftSelect")
            {
				...
				public void actionPerformed(ActionEvent e)
                {
                    if( selectionType == 1 && cheatShift )
                    {
                        ...
                        selectButton.setColors(dispMDL.getProgramPreferences().getActiveColor1(),dispMDL.getProgramPreferences().getActiveColor2());
                        selectionType = 0;
                        cheatShift = false;
                    }
                }
	...
	public void actionPerformed(ActionEvent e)
    {
        ...
        else if( e.getSource() == loadImage )
        {
    		...
    		if( x == JOptionPane.YES_OPTION )
    		{
        		...
        		{
            		vp.addBackgroundImage(materialsList.getSelectedValue().getBufferedImage(dispMDL.getMDL().getWorkingDirectory()));
        		}
    		}
    		else if( x == JOptionPane.NO_OPTION )
    		{
    			JFileChooser jfc = new JFileChooser();
                MDL current = dispMDL.model;
...
//        		}
        ...
        else
        {
            ...
            for( int i = 3; i < 6 && !done; i++ )
            {
                if( e.getSource() == buttons.get(i) )
                {
                    ...
                    buttons.get(i).setColors(dispMDL.getProgramPreferences().getActiveRColor1(),dispMDL.getProgramPreferences().getActiveRColor2());
                    actionType = i;
                }
            }
            for( int i = 0; i < 3 && !done; i++ )
            {
                if( e.getSource() == buttons.get(i) )
                {
                    ...
                    buttons.get(i).setColors(dispMDL.getProgramPreferences().getActiveColor1(),dispMDL.getProgramPreferences().getActiveColor2());
                    selectionType = i;
                }
            }
        }
    ...
    public void setDimLock(int x, boolean flag)
    {
        ...
        if( dimLocks[x] )
        {
            getDLockButton(x).setColors(dispMDL.getProgramPreferences().getActiveBColor1(),dispMDL.getProgramPreferences().getActiveBColor2());
        }
        else
        {
