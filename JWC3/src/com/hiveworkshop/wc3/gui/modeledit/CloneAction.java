...
public class CloneAction extends UndoAction
{
    ...
    boolean type;
    public CloneAction(final ArrayList<Vertex> selection, final Vertex moveVector, final ArrayList<GeosetVertex> clones, final ArrayList<Triangle> addedTriangles, final boolean isExtrude)
    {
        addedVerts = clones;
