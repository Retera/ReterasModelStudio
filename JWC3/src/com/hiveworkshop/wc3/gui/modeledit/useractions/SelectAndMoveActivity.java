...
public class SelectAndMoveActivity extends AbstractSelectAndEditActivity
	...
	protected void doMouseMove(final MouseEvent e, final CoordinateSystem coordinateSystem,
			final SelectingEventHandler selectionManager) {
		if (moverWidget != null) {
	...
	protected void doDrag(final MouseEvent e, final CoordinateSystem coordinateSystem,
			final SelectingEventHandler selectionManager, final Double startingClick, final Double endingClick) {
	...
	protected boolean doStartAction(final MouseEvent e, final CoordinateSystem coordinateSystem,
			final SelectingEventHandler selectionManager, final Double startingClick) {
	...
	@Override
	protected void onReset(final SelectingEventHandler selectionManager, final CursorManager cursorManager,
