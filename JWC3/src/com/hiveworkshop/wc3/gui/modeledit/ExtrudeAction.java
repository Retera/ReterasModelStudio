 ...
 * 6/11/2012
 */
public class ExtrudeAction extends UndoAction
{
    ...
    boolean type;
    public ExtrudeAction(final ArrayList<Vertex> selection, final Vertex moveVector, final ArrayList<GeosetVertex> clones, final ArrayList<Triangle> addedTriangles, final boolean isExtrude)
    {
        addedVerts = clones;
