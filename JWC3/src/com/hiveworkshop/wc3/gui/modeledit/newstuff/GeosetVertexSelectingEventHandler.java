...
public final class GeosetVertexSelectingEventHandler extends AbstractSelectingEventHandler<GeosetVertex> {
	private final ModelView model;
	private final ProgramPreferences programPreferences;

	public GeosetVertexSelectingEventHandler(final SelectionManager<GeosetVertex> selectionManager,
