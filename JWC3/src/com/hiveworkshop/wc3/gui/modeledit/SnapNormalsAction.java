 ...
 * 6/11/2012
 */
public class SnapNormalsAction extends UndoAction
{
    ArrayList<Vertex> oldSelLocs;
    ArrayList<Vertex> selection;
    Vertex snapPoint;
    public SnapNormalsAction(final ArrayList<Vertex> selection, final ArrayList<Vertex> oldSelLocs, final Vertex snapPoint)
    {
