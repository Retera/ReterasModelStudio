...
public class GlobalIcons {
    ...
    public static final ImageIcon orangeIcon = new ImageIcon(GlobalIcons.class.getResource("ImageBin/BlankOrange_small.png"));
    public static final ImageIcon cyanIcon = new ImageIcon(GlobalIcons.class.getResource("ImageBin/BlankCyan_small.png"));
    public static final ImageIcon redXIcon = new ImageIcon(GlobalIcons.class.getResource("ImageBin/redX.png"));
    public static final ImageIcon greenArrowIcon = new ImageIcon(GlobalIcons.class.getResource("ImageBin/greenArrow.png"));
