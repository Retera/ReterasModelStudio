...
public class Camera implements Named
{
    ...
    public Camera(CameraChunk.Camera mdxSource) {
		...
		if( mdxSource.cameraTargetTranslation != null ) {
			add(new AnimFlag(mdxSource.cameraTargetTranslation));
		}
    ...
    public static Camera read(BufferedReader mdl)
    {
        ...
        {
            JOptionPane.showMessageDialog(MDLReader.getDefaultContainer(),"Unable to parse Camera: Missing or unrecognized open statement.");
        }
        return null;
    }
	...
	public void setTargetPosition(Vertex targetPosition) {
		this.targetPosition = targetPosition;
	}
	public ArrayList<AnimFlag> getTargetAnimFlags() {
		return targetAnimFlags;
	}
	public void setTargetAnimFlags(ArrayList<AnimFlag> targetAnimFlags) {
