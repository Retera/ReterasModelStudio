...
//             }
    ...
    public Matrix(final ArrayList<Bone> newBones)
    {
...
//         System.out.println("Warning: A matrix with no contents was used!");
    ...
    public static Matrix parseText(final String input)
    {
        ...
        if( size == 1 )
        {
            ...
            {
                JOptionPane.showMessageDialog(MDLReader.getDefaultContainer(),"Error \""+input+"\": Matrix data could not be interpreted.");
            }
        }
        else
        {
