...
public class Animation
{
    ...
    public boolean equalsAnim(Animation other) {
     ...
     */
    public Animation(SequenceChunk.Sequence seq) {
...
//         }
    ...
    public static Animation parseText(String [] line)
    {
        if( line[0].contains("Anim") )
        {
            ...
            {
                JOptionPane.showMessageDialog(MDLReader.getDefaultContainer(),"Unable to parse animation: Interval could not be interpreted numerically.");
            }
        ...
        {
            JOptionPane.showMessageDialog(MDLReader.getDefaultContainer(),"Unable to parse animation: Missing or unrecognized open statement.");
        }
        return null;
    }
...
//             System.out.println("Throwing nameless anim from: "+MDLReader.nextLine(mdl));//Read the word "Anim" from the top
        ...
        if( !limited )
        {
//             JOptionPane.showMessageDialog(MDLReader.getDefaultContainer(),"This popup means Anims were interpreted as outside geoset!");
//             try
//             {
