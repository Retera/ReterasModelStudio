...
//    }
	...
	public static Bitmap parseText(final String [] line)
    {
        if( line[0].contains("Bitmap") )
        {
            ...
            for( int i = 1; i < line.length; i++ )
            {
                ...
                else if( line[i].contains("ReplaceableId ") )
                {
                    ...
                    {
                        JOptionPane.showMessageDialog(MDLReader.getDefaultContainer(),"Error while parsing bitmap: Could not interpret ReplaceableId.");
                    }
                }
                ...
                {
                    JOptionPane.showMessageDialog(MDLReader.getDefaultContainer(),"Error parsing Bitmap: Unrecognized statement '"+line[i]+"'.");
                }
            }
            return tex;
        }
        ...
        {
            JOptionPane.showMessageDialog(MDLReader.getDefaultContainer(),"Unable to parse Bitmap: Missing or unrecognized open statement.");
        }
        return null;
    }
...
//                     }
                ...
                {
                    JOptionPane.showMessageDialog(MDLReader.getDefaultContainer(),"Error parsing Bitmap: Unrecognized statement '"+line+"'.");
                }
            }
            return tex;
        }
    ...
    {
        String line = "";
        final ArrayList<Bitmap> outputs = new ArrayList<Bitmap>();
        MDLReader.mark(mdl);
        ...
        {
            MDLReader.reset(mdl);
//            JOptionPane.showMessageDialog(MDLReader.getDefaultContainer(),"Unable to parse Textures: Missing or unrecognized open statement.");
        }
        return outputs;
    }
