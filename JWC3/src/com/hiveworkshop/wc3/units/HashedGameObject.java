...
public class HashedGameObject implements GameObject {
	HashMap<String,String> fields = new HashMap<String,String>();
	String id;
	ObjectData parentTable;

	transient HashMap<String,List<GameObject>> hashedLists = new HashMap<String,List<GameObject>>();
...
//		if( fieldAsList == null ) {
			fieldAsList = new ArrayList<GameObject>();
